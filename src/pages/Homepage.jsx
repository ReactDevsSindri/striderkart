...
const Homepage = () => {
  return (
    <>
      <main
        className={` font-mono flex flex-col-reverse p-5  md:flex-row pt-28 pl-10 dark:bg-slate-800 dark:text-white h-screen`}
      >
        <div>
          <h1 className="text-6xl md:text-8xl max-[400px]:text-3xl">YOUR FEET DESERVE THE BEST</h1>
